 ...
 * 
 * Note: These tests require a valid OpenAI API key set in the OPENAI_API_KEY
 * environment variable. They are automatically skipped when the key is not set.
 */
@EnabledIfEnvironmentVariable(named = "OPENAI_API_KEY", matches = ".+")
class EmbeddingGenerationPropertyTest {

        /**
         * Property 11: For any document chunk, an embedding vector should be
         * successfully generated.
         * 
         * This test verifies that the embedding engine can generate embeddings for any
         * valid
        ...
        /**
         * Property 11 variant: Batch embedding generation should work for multiple
         * chunks.
         * 
        ...
        /**
         * Property 11 variant: Embeddings should be generated for chunks with various
         * content types.
         * 
        ...
        void embeddingsShouldBeGeneratedForVariousContentTypes(
                ...
                try {
                        ...
                        assertNotNull(embedding,
                                        "Embedding should be generated for content: "
        ...
        Arbitrary<DocumentChunk> validDocumentChunk() {
                ...
                ).as((id, docId, content, index, metadata) -> DocumentChunk.builder()
                                .id(id)
                                .documentId(docId)
                                .content(content)
                                .chunkIndex(index)
        ...
        Arbitrary<DocumentMetadata> validMetadata() {
                ...
                ).as((author, timestamps, url, permissions) -> DocumentMetadata.builder()
                                .author(author)
